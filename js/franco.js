var fotosFranco = new Array()

for (i = 0; i <= 15; i++) {
    fotosFranco[i] = '../images/fotos/Franco/'+ i +'.jpg';
}
let contador = 2;
let contadorColumnas = 0;
contadorGaleria = 0;

console.log(fotosFranco);
...
function galeria () {
    ...
    do {
        ...
        for (i = 0; i<=2; i++) {
            ...
            foto = $("<img>");
            $(foto).attr("src", fotosFranco[contador]);
            $(columna).append(foto);
    ...
    } while (contador <= fotosFranco.length)
}