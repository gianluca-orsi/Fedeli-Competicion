var fotosJuampi = new Array()

for (i = 0; i <= 14; i++) {
    fotosJuampi[i] = '../images/fotos/Juampi/'+ i +'.jpg';
}
let contador = 2;
let contadorColumnas = 0;
contadorGaleria = 0;

console.log(fotosJuampi);
...
function galeria () {
    ...
    do {
        ...
        for (i = 0; i<=2; i++) {
            ...
            foto = $("<img>");
            $(foto).attr("src", fotosJuampi[contador]);
    ...
    } while (contador <= fotosJuampi.length)
}