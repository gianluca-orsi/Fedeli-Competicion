var fotosGaspar = new Array()

for (i = 0; i <= 34; i++) {
    fotosGaspar[i] = '../images/fotos/Gaspar/'+ i +'.jpg';
}
let contador = 2;
let contadorColumnas = 0;
contadorGaleria = 0;

console.log(fotosGaspar);
...
function galeria () {
    ...
    do {
        ...
        for (i = 0; i<=2; i++) {
            ...
            foto = $("<img>");
            $(foto).attr("src", fotosGaspar[contador]);
            $(columna).append(foto);
    ...
    } while (contador <= fotosGaspar.length)
}